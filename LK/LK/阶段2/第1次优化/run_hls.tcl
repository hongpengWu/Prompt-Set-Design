...
if {$CSIM == 1} {
  csim_design -ldflags "${LD_FLAGS}" -argv "/root/autodl-tmp/whp/Vitis-Libraries-LK/vision/data/lkof_im0_256x128.png /root/autodl-tmp/whp/Vitis-Libraries-LK/vision/data/lkof_im1_256x128.png"
}
...
if {$COSIM == 1} {
  cosim_design -ldflags "${LD_FLAGS}" -argv "/root/autodl-tmp/whp/Vitis-Libraries-LK/vision/data/lkof_im0_256x128.png /root/autodl-tmp/whp/Vitis-Libraries-LK/vision/data/lkof_im1_256x128.png"
}
