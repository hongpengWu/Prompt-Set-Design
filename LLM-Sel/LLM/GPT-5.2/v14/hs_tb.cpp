...
static void draw_arrow(uint8_t *rgb, int width, int height, int x0, int y0, int x1, int y1, uint8_t r, uint8_t g, uint8_t b) {
    ...
    draw_line(rgb, width, height, x0, y0, x1, y1, r, g, b, 1);
    ...
    draw_line(rgb, width, height, x1, y1, wing1_x, wing1_y, r, g, b, 1);
    draw_line(rgb, width, height, x1, y1, wing2_x, wing2_y, r, g, b, 1);
}
...
int main(int argc, char **argv) {
    ...
    const char *out_path = "/home/whp/Desktop/XLab/M2HLS/hls_out_flow14.png";
