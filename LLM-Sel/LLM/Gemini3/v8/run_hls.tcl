...
# Summary Check
set csynth_rpt "$PROJ/$SOLN/syn/report/hls_HS_csynth.rpt"
if {[file exists $csynth_rpt]} {
    puts "Synthesis Report Found: $csynth_rpt"
    # Optional: Read and print BRAM usage or check timing
} else {
    puts "Synthesis Report NOT Found."
}
