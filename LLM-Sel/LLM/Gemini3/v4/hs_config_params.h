...
// Iterations: 20 is chosen as a standard for HS convergence on small images.
// Matlab baseline default is 100, but Prompt suggests 10/20/50.
#define N_ITER 20
...
// - 8 integer bits (including sign) -> Range +/- 128 pixels (Covers +/- 64 requirement)
// Scaling Factor: 256 (Raw integer value = Real value * 256)
...
// Using ap_fixed<16, 12> to align with 16-bit words.
...
// Using ap_fixed<32, 22> to be safe and efficient.
...
// Prompt requires > 18 bits integer width.
