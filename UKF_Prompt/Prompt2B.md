...
- ** `run_hls.tcl`只能修改时钟频率**（除非我明确允许，其余的不得修改）。
...
你只做“结构性算法优化”，目标是把瓶颈从“结构导致的串行/冲突/长路径”转化为“规则并行 + 可收敛的存储/互连。也就是保持资源不超限的前提下，尽可能压低T_exec `\home\whp\Desktop\XLab\UKF_Experiment\UKF2HLS\reports\summary_T_exec.txt` ”：
...
#### 3.2 工具反馈（至少其一）
- `csynth.rpt`：/home/whp/Desktop/XLab/UKF_Experiment/UKF2HLS/ukf2hls_prj/sol1/syn/report/csynth.rpt
- `hls_SR_UKF_csynth.xml`：/home/whp/Desktop/XLab/UKF_Experiment/UKF2HLS/ukf2hls_prj/sol1/syn/report/hls_SR_UKF_csynth.xml
- `hls_SR_UKF_cosim.rpt`：/home/whp/Desktop/XLab/UKF_Experiment/UKF2HLS/ukf2hls_prj/sol1/sim/report/hls_SR_UKF_cosim.rpt
...
- 用vitis_hls run_hls.tcl运行，且 run_hls.tcl 只允许修改时钟频率，其余不得修改。以上提供的相关文件路径均为绝对路径，工作区搜索时可以按照相对路径，均在 `\home\whp\Desktop\XLab\UKF_Experiment\UKF2HLS` 下
